  ...
  template: `
    <div class="p-4">
      ...
      <div class="mb-6">
        ...
        <button (click)="service.postsResource.reload()" class="mt-2 bg-blue-500 text-white px-4 py-2 rounded">
          Reload Posts
        </button>
      </div>
      ...
      <div class="mb-6">
        ...
        <button (click)="service.userWithPostsResource.reload()" class="mt-2 bg-blue-500 text-white px-4 py-2 rounded">
