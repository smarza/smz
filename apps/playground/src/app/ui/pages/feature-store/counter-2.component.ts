...
import { COUNTER_2_STORE_TOKEN, CounterStore, counter2StoreProvider } from './counter-2-store.provider';

@Component({
  selector: 'app-counter-2',
  standalone: true,
  imports: [CommonModule, ButtonModule],
  providers: [counter2StoreProvider],
  host: { class: 'flex flex-col gap-4' },
  template: `
  <div class="flex flex-col gap-2">
    <div class="text-3xl font-bold">Counter 2</div>
...
export class Counter2Component implements OnInit, OnDestroy {
  public readonly store: CounterStore = inject(COUNTER_2_STORE_TOKEN);
